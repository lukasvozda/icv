...
<main>
		...
		<div class="container mx-auto flex px-5 md:py-24 md:flex-row flex-col">
			...
			>
				...
				<p class="mb-8 leading-relaxed">
					I'm a tech and data enthusiast and have been working for 7 years as a Head of Analytics &
					CTO at Proficio. I write about my work and my other passions on my blog. Want to know more
					about my skills and carrier? Check out my online resume.
				</p>
				<div class="flex">
	...
	<section>
		<div class="container md:py-24">
			...
			<p>
				I have 8+ years experience of performing in an online commerce enviroment and as a freelance
				analyst/developer. I went through a lot of online business models (from B2B to ecommerce)
				and helped our clients build realiable and automated reporting. Started off as a single
				analyst in the company, grew up to the team of 10 people. Below are my skills and tools that
				I use daily.
			</p>
		</div>
	</section>
